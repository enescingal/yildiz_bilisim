...
<head>
    ...
    <link rel="stylesheet" href="../pages/listele.php">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-4">
                ...
                <ul class="list-unstyled text-small">
                    <li class="mb-1"><a class="link-secondary text-decoration-none">15 yıllık tecrübe ve profesyonel
                            ekibimiz ile
                            siz değerli müşterilerimize hizmet vermekteyiz.</a>
                    </li>
                </ul>
            </div>
            <div class="col-4">
                <h6>Sayfalar</h6>
                <ul class="list-unstyled text-small">
                    <li class="mb-1"><a class="link-secondary text-decoration-none" href="anasayfa.php">Anasayfa</a>
                    </li>
